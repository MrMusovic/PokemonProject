...
718,Zygarde,Dragon,Ground,600,108,100,121,81,95,95,6,True
719,Diancie,Rock,Fairy,600,50,100,150,100,150,50,6,True
720,Hoopa,Psychic,Ghost,600,80,110,60,150,130,70,6,True
721,Volcanion,Fire,Water,600,80,110,120,130,90,70,6,True`.split('\n')
...
function clickButton() {
    ...
    for (i=0; i<database.length; i++) {
        ...
        if (linetoread[0].toLowerCase().indexOf(searchbox.value.toLowerCase()) != -1) {
            results.push(linetoread[1])
            resultinfo.push(linetoread)
        }
    }
    ...
    switch (results.length) {
        ...
        case 1:
            ...
            if (resultinfo[0][0] < 494) {
                pokemonImage.src = "images/POKEMON/"+resultinfo[0][0]+" "+results+".ico";
            } else {
                pokemonImage.src = "images/gen5pokemon/"+resultinfo[0][0] +".png";
            }
